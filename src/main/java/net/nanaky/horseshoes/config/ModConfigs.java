...
public class ModConfigs {
    ...
    public static void registerConfigs() {
        ...
        COPPER_HORSESHOES_ARMOR  = getFloat(json, "copper_horseshoes_armor",   0.50f);
        ...
        IRON_HORSESHOES_ARMOR    = getFloat(json, "iron_horseshoes_armor",     2.00f);
        ...
        GOLDEN_HORSESHOES_ARMOR  = getFloat(json, "golden_horseshoes_armor",   1.00f);
        ...
        DIAMOND_HORSESHOES_ARMOR = getFloat(json, "diamond_horseshoes_armor",  3.00f);
        ...
        NETHERITE_HORSESHOES_ARMOR = getFloat(json, "netherite_horseshoes_armor", 3.50f);
    }
