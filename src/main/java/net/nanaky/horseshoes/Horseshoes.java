...
import static net.nanaky.horseshoes.items.ModItems.*;
...
import net.nanaky.horseshoes.items.ModItems;

public class Horseshoes implements ModInitializer {

    public static final String MOD_ID = "horseshoes";

    // UUID → Identifier for attribute modifiers (changed in 1.21.2)
    public static final Identifier HORSESHOES_SPEED_ID =
            Identifier.fromNamespaceAndPath(MOD_ID, "horseshoesspeed_bonus");
    public static final Identifier HORSESHOES_JUMP_ID =
        Identifier.fromNamespaceAndPath(MOD_ID, "horseshoesjump_bonus");
    public static final Identifier HORSESHOES_ARMOR_ID =
            Identifier.fromNamespaceAndPath(MOD_ID, "horseshoesarmor_bonus");

    // TagKey.of → TagKey.create; RegistryKeys → Registries (Mojang)
